    ...
    <Sidebar title={"Upload Documents"}>
      <Box sx={{ display: "flex", justifyContent: "center" }}>
        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", position: 'absolute', top: '10%' }}>
          ...
          <Box sx={{ width: "100%", mt: 1, overflowY: 'auto', height: creditBureauFile === null || bankStatementFile === null || creditBureauFile === null ? '' : '25vh', scrollbarWidth: 'none' }}>
            {[idProofFile, bankStatementFile, creditBureauFile].filter(Boolean).map((file, index) => renderFileCard(file))}
          </Box>
