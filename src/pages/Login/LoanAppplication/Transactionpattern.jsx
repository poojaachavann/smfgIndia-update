...
export default function Transactionpattern() {
    ...
    console.log('selectedData', selectedData[0]?.check_history[0]?.text?.transaction_pattern_report.transactions
    )
    ...
    const paginatedData = selectedData[0]?.check_history[0]?.text?.transaction_pattern_report?.transactions.slice(
        (currentPage_1 - 1) * itemsPerPage,
        currentPage_1 * itemsPerPage
    );

    const totalPages_1 = Math.ceil(selectedData[0]?.check_history[0]?.text?.transaction_pattern_report?.transactions?.length / itemsPerPage);
    ...
    return (
        <>
            ...
            <Sidebar title={'Transaction Pattern'}>


                <Typography sx={{ fontSize: '14px', color: '#656565', fontWeight: '600', textAlign: 'end', mr: '20px', mt: '20px' }}>Total Score: {selectedData[0]?.check_history[0]?.text?.transaction_pattern_report?.overall_score || 0}</Typography>
                            ...
                            <ul style={{ marginLeft: '10%' }}>
                                <li>
                                    <Typography sx={{ fontSize: '14px', color: '#000', fontWeight: '500', mb: '10px' }}>
                                        <strong>Transaction Category:</strong> {data.transaction_category}
                                    </Typography>
                                </li>
                                <li>
                                    <Typography sx={{ fontSize: '14px', color: '#000', fontWeight: '500', mb: '10px' }}>
                                ...
                                <li>
                                    <Typography sx={{ fontSize: '14px', color: '#000', fontWeight: '500', mb: '10px' }}>
                                        <strong>Transaction Type:</strong> {data.sub_category}
                                    </Typography>
                                </li>
                                <li>
                                    <Typography sx={{ fontSize: '14px', color: '#000', fontWeight: '500', mb: '10px' }}>
